...
function listarDias(req, res) {
    var mac = req.params.mac

    usuarioModel.listarDias(mac)
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
...
function mediasRam(req, res) {
    var mac = req.params.mac

    usuarioModel.mediasRam(mac)
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
...
function mediasCPU(req, res) {
    var mac = req.params.mac

    usuarioModel.mediasCPU(mac)
        .then(function (resultado) {
...
function mediasDisco(req, res) {
    var mac = req.params.mac

    usuarioModel.mediasDisco(mac)
        .then(function (resultado) {
            console.log(resultado+ 'essa é a resposta')
            if (resultado.length > 0) {
                res.status(200).json(resultado);
                console.log(resultado+ 'essa é a resposta')
            } else {
...
function selectComputadores1(req, res) {

    var nomeEmpresa = req.params.nomeEmpresa

    usuarioModel.selectComputadores1(nomeEmpresa)
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json(resultado);
            } else {
